...
// OSPFProtocolLister helps list OSPFProtocols.
// All objects returned here must be treated as read-only.
type OSPFProtocolLister interface {
...
// oSPFProtocolLister implements the OSPFProtocolLister interface.
type oSPFProtocolLister struct {
