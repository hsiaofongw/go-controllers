...
// fakeWireGuardInterfaces implements WireGuardInterfaceInterface
type fakeWireGuardInterfaces struct {
	*gentype.FakeClientWithList[*v1alpha1.WireGuardInterface, *v1alpha1.WireGuardInterfaceList]
...
func newFakeWireGuardInterfaces(fake *FakeNetworkingV1alpha1) networkingv1alpha1.WireGuardInterfaceInterface {
	return &fakeWireGuardInterfaces{
		gentype.NewFakeClientWithList[*v1alpha1.WireGuardInterface, *v1alpha1.WireGuardInterfaceList](
			...
			func() *v1alpha1.WireGuardInterfaceList { return &v1alpha1.WireGuardInterfaceList{} },
			func(dst, src *v1alpha1.WireGuardInterfaceList) { dst.ListMeta = src.ListMeta },
			func(list *v1alpha1.WireGuardInterfaceList) []*v1alpha1.WireGuardInterface {
				return gentype.ToPointerSlice(list.Items)
			},
			func(list *v1alpha1.WireGuardInterfaceList, items []*v1alpha1.WireGuardInterface) {
